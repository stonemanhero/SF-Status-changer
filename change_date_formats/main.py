...
important_fields = [
            ...
            'CREATEDDATE__C',
            'DATE_OF_BIRTH__C',
            'EXPECTEDPAYDOWNDATE__C',
            'PARTIAL_PAYMENT_DATE__C'
        ]
"""

important_fields = ['PARTIAL_PAYMENT_DATE__C']
...
def main():
    ...
    with open('output/opportunity_formated_dates2.csv', 'wb') as file_output:
        with open('input/opportunity_errors2.csv', 'rb') as file_input:
                ...
                for field in fieldnames:
                    if field in important_fields:
                        if row[field]:
                            ...
                            if year >= 40:
                                formated_date = '19' + str(year) + '-' + month + '-' + day + 'T18:14:36.000Z'
                            else:
                                formated_date = '20' + str(year) + '-' + month + '-' + day + 'T18:14:36.000Z'
