...
def main():
    ...
    with open('output/opportunity_conditions_changed.csv', 'wb') as output_lead_conditions_changed:
    ...
    with open('output/opportunity_invoice_changed.csv', 'wb') as output_lead_invoice_changed:
